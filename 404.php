<?php get_header(); ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php _e('Oooops... Error 404','sleekr'); ?>
                </h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="jumbotron">
                    ...
                    <p><?php _e('The page you\'re looking for could not be found. Here are some helpful links to get you back on track:','sleekr');?></p>
                    <div class="row">
