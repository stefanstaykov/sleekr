...
<head>
    ...
    <style>
        ...
        .comment-list .bypostauthor .pull-left:after {content: "<?php echo esc_html_x('Author','Comment by Post Author','sleekr') ?>"}
    </style>
</head>
  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
        <span class="sr-only"><?php esc_html_e('Toggle navigation','sleekr'); ?></span>
